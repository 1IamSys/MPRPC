...
const char descriptor_table_protodef_friend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ndsListRequest\022\013\n\003uid\030\001 \001(\r\"M\n\026GetFriend"
  "sListResponse\022\"\n\006result\030\001 \001(\0132\022.fixbug.R"
  "esultCode\022\017\n\007friends\030\002 \003(\r2c\n\020FriendServ"
  "iceRpc\022O\n\016GetFriendsList\022\035.fixbug.GetFri"
  "endsListRequest\032\036.fixbug.GetFriendsListR"
...
const ::_pbi::DescriptorTable descriptor_table_friend_2eproto = {
    false, false, 300, descriptor_table_protodef_friend_2eproto,
    "friend.proto",
  ...
  // repeated uint32 friends = 2;
  {
    ...
    if (byte_size > 0) {
      target = stream->WriteUInt32Packed(
          2, _internal_friends(), byte_size, target);
    }
  }
