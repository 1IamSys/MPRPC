...
inline uint32_t GetFriendsListRequest::_internal_uid() const {
  return _impl_.uid_;
}
inline uint32_t GetFriendsListRequest::uid() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendsListRequest.uid)
  return _internal_uid();
}
inline void GetFriendsListRequest::_internal_set_uid(uint32_t value) {
  
  _impl_.uid_ = value;
}
inline void GetFriendsListRequest::set_uid(uint32_t value) {
...
inline uint32_t GetFriendsListResponse::_internal_friends(int index) const {
  return _impl_.friends_.Get(index);
}
inline uint32_t GetFriendsListResponse::friends(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendsListResponse.friends)
  return _internal_friends(index);
}
inline void GetFriendsListResponse::set_friends(int index, uint32_t value) {
  _impl_.friends_.Set(index, value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendsListResponse.friends)
}
inline void GetFriendsListResponse::_internal_add_friends(uint32_t value) {
  _impl_.friends_.Add(value);
}
inline void GetFriendsListResponse::add_friends(uint32_t value) {
