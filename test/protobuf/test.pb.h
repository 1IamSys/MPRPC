...
// uint32 friend_id = 1;
inline void GetFriendListRequest::clear_friend_id() {
  _impl_.friend_id_ = 0u;
}
inline uint32_t GetFriendListRequest::_internal_friend_id() const {
  return _impl_.friend_id_;
}
inline uint32_t GetFriendListRequest::friend_id() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListRequest.friend_id)
  return _internal_friend_id();
}
inline void GetFriendListRequest::_internal_set_friend_id(uint32_t value) {
  
  _impl_.friend_id_ = value;
}
inline void GetFriendListRequest::set_friend_id(uint32_t value) {
  _internal_set_friend_id(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListRequest.friend_id)
}
