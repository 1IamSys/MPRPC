...
class RpcHeader final :
 ...
 public:
  ...
  uint32_t agrs_size() const;
  void set_agrs_size(uint32_t value);
  private:
  uint32_t _internal_agrs_size() const;
  void _internal_set_agrs_size(uint32_t value);
  public:
...
inline uint32_t RpcHeader::_internal_agrs_size() const {
  return _impl_.agrs_size_;
}
inline uint32_t RpcHeader::agrs_size() const {
  // @@protoc_insertion_point(field_get:mprpc.RpcHeader.agrs_size)
  return _internal_agrs_size();
}
inline void RpcHeader::_internal_set_agrs_size(uint32_t value) {
  
  _impl_.agrs_size_ = value;
}
inline void RpcHeader::set_agrs_size(uint32_t value) {
